...
Module Info.
  ...
  Definition source_file := "lfharm.c".
...
Definition _lfstep : ident := $"lfstep".
          ...
          (Ebinop Oadd
            ...
            (Ebinop Omul
              (Ebinop Omul
                ...
                (Ebinop Omul (Etempvar _h tfloat) (Etempvar _h tfloat)
        ...
        (Sassign
          ...
          (Ebinop Oadd (Etempvar _t'3 tfloat)
            (Ebinop Omul
              (Ebinop Omul
                (Econst_single (Float32.of_bits (Int.repr 1056964608)) tfloat)
                (Etempvar _h tfloat) tfloat)
              (Ebinop Oadd (Etempvar _a tfloat) (Etempvar _t'2 tfloat)
...
((___compcert_va_int32,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_force, Gfun(Internal f_force)) :: (_lfstep, Gfun(Internal f_lfstep)) ::
 (_integrate, Gfun(Internal f_integrate)) ::
 (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _integrate :: _lfstep :: _force :: ___builtin_debug ::
